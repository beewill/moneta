  ...
  module Adapters
    ...
    class Sequel
      ...
      def initialize(options = {})
        ...
        @backend = options.delete(:backend) || connect(extensions: extensions, connection_validation_timeout: connection_validation_timeout, **options)
        add_extensions if optimize == nil || optimize
